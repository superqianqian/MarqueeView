...
public class MainActivity extends AppCompatActivity {
    ...
    void initTextMarequee() {
        ...
        mTextMarequee.setScrollDirection(MarqueeViewKt.RIGHT_TO_LEFT);
    ...
    void initTextsMarequee() {
        ...
        mTextsMarequee.setScrollDirection(MarqueeViewKt.RIGHT_TO_LEFT);
    ...
    void initImageMarequee() {
        ...
        mImageMarequee.setScrollDirection(MarqueeViewKt.RIGHT_TO_LEFT);
    ...
    void initImageAndTextMarequee() {
        ...
        mImageAndTextMarequee.setScrollDirection(MarqueeViewKt.LEFT_TO_RIGHT);
