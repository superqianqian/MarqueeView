...
public class MarqueeViewJava extends HorizontalScrollView implements Runnable {
    ...
    public MarqueeViewJava(Context context) {
        this(context, null);
    }

    public MarqueeViewJava(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MarqueeViewJava(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addViewInQueue(View view) {
        ...
        viewRightMargin = (screenWidth - view.getMeasuredWidth()) < 0 ? screenWidth/2 : screenWidth - view.getMeasuredWidth();
        ...
        viewWidth = viewWidth + view.getMeasuredWidth() + viewMargin + viewRightMargin;
    }

    public void addViewsInQueue(List<View> views) {
    ...
    public int getViewCount() {
        if (null != mainLayout) {
            return mainLayout.getChildCount();
        } else {
            return 0;
        }
    }
